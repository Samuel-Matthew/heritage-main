          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div>
              ...
              <p className="text-primary-foreground/70 text-sm">
                Get the latest deals and industry updates
              </p>
            </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
          ...
          <div className="col-span-2 md:col-span-1 lg:col-span-2">
            ...
            <p className="text-primary-foreground/70 text-sm mb-4 max-w-xs">
              Nigeria's premier multi-vendor marketplace for oil & gas products.
              Connect with trusted suppliers nationwide.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-primary-foreground/70">
              ...
              <li className="flex items-center gap-2">
                ...
                <span>support@heritageenergyglobal.com</span>
              </li>
            </ul>
          </div>
        </div>
